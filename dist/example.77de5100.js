...
var Request = /** @class */function () {
  function Request(axiosConfig, config) {
    ...
    this._authorizationKey = (_a = config === null || config === void 0 ? void 0 : config.authorizationKey) !== null && _a !== void 0 ? _a : DefaultConfig.authorizationKey;
    this._authorizationPrefix = (_b = config === null || config === void 0 ? void 0 : config.authorizationPrefix) !== null && _b !== void 0 ? _b : DefaultConfig.authorizationPrefix;
  }
  Object.defineProperty(Request.prototype, "token", {
    set: function set(accessToken) {
      this._instance.defaults.headers[this._authorizationKey] = "".concat(this._authorizationPrefix, " ").concat(accessToken);
    },
    enumerable: false,
    configurable: true
  });
  Request.prototype.get = function (url, params) {
    ...
    var response = this._instance.get(url, {
      params: params,
      signal: controller.signal
    });
    var parse = function parse(input) {
      return response.then(function (res) {
        return input(res.data);
      });
    };
    return {
      response: response,
  ...
  Request.prototype.downlaod = function (url, data) {
    var controller = new AbortController();
    var progressHandler = new ( /** @class */function () {
      function CreateProcessHandler() {
        this._handler = function () {};
      }
      CreateProcessHandler.prototype.get = function () {
        return this._handler;
      };
      CreateProcessHandler.prototype.set = function (handler) {
        this._handler = handler;
      };
      return CreateProcessHandler;
    }())();
    var onProgress = function onProgress(type, e) {
      var handler = progressHandler.get();
      handler && handler(type, e);
    };
    var response = this._instance.post(url, data, {
      signal: controller.signal,
      onUploadProgress: function onUploadProgress(e) {
        return onProgress('upload', e);
      },
      onDownloadProgress: function onDownloadProgress(e) {
        return onProgress('download', e);
      }
    });
    var parse = function parse(input) {
      return response.then(function (res) {
...
},{"axios":"../node_modules/axios/index.js"}],"../node_modules/zod/lib/index.mjs":[function(require,module,exports) {
"use strict";
...
exports.function = exports.enum = exports.effect = exports.discriminatedUnion = exports.defaultErrorMap = exports.default = exports.date = exports.custom = exports.coerce = exports.boolean = exports.bigint = exports.array = exports.any = void 0;
...
exports.symbol = exports.string = exports.strictObject = void 0;
exports.z = exports.void = exports.util = exports.unknown = exports.union = exports.undefined = exports.tuple = exports.transformer = void 0;
var util;
exports.util = util;
(function (util) {
...
exports.ZodType = exports.ZodSchema = exports.Schema = ZodType;
...
exports.ZodTransformer = exports.ZodEffects = ZodEffects;
...
exports.transformer = exports.effect = effectsType;
...
(function () {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          Resource = function Resource(input) {
            try {
              var zKpxIdentifier = zod_1.default.object({
                id: zod_1.default.number(),
                kpx_cbp_gen_id: zod_1.default.string()
              }).nullable();
              var Object = zod_1.default.object({
                count: zod_1.default.number(),
                next: zod_1.default.number().nullable(),
                previous: zod_1.default.number().nullable(),
                results: zod_1.default.array(zod_1.default.object({
                  id: zod_1.default.number(),
                  type: zod_1.default.union([zod_1.default.literal('태양광'), zod_1.default.literal('풍력')]),
                  modified_at: zod_1.default.string().refine(function (value) {
                    var date = new Date(value);
                    return !isNaN(date.getTime());
                  }),
                  infra: zod_1.default.object({
                    id: zod_1.default.number(),
                    ...
                    altitude: zod_1.default.number().nullable(),
                    capacity: zod_1.default.number().nullable(),
                    install_date: zod_1.default.string().regex(/^(?:19|20)\d\d-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|[12][0-9]|3[01]))$/).nullable(),
                    kpx_identifier: zKpxIdentifier,
                    inverter: zod_1.default.array(zod_1.default.object({
                      id: zod_1.default.number(),
                      capacity: zod_1.default.number(),
                      tilt: zod_1.default.number(),
                      azimuth: zod_1.default.number()
                    })),
                    ess: zod_1.default.array(zod_1.default.object({
                      id: zod_1.default.number(),
                      kpx_identifier: zKpxIdentifier,
                      ess_cap: zod_1.default.number(),
                      ess_soc_l_lim: zod_1.default.number(),
                      ess_soc_h_lim: zod_1.default.number(),
                      pcs_cap: zod_1.default.number(),
                      pcs_h_lim: zod_1.default.number().nullable(),
                      ch_start: zod_1.default.number().min(1).max(24),
                      ch_end: zod_1.default.number().min(1).max(24),
                      dch_start: zod_1.default.number().min(1).max(24),
                      dch_end: zod_1.default.number().min(1).max(24),
                      ess_loss_eff: zod_1.default.number().nullable(),
                      ess_reserve: zod_1.default.number().nullable(),
                      ch_min_cap: zod_1.default.number().nullable(),
                      ch_max_cap: zod_1.default.number().nullable(),
                      dch_min_cap: zod_1.default.number().nullable(),
                      dch_max_cap: zod_1.default.number().nullable(),
                      ess_mfr: zod_1.default.number().nullable(),
                      pcs_mfr: zod_1.default.number().nullable(),
                      out_ctrl_feat: zod_1.default.string().nullable()
                    })).optional()
                  })
                }))
              });
          ...
          return [4 /*yield*/, request.get('/resource').parse(Resource)];
        case 1:
          resource = _a.sent();
          if (!resource) return [2 /*return*/];
          console.log(resource.results.forEach(function (r) {
            console.log(r);
          }));
          return [2 /*return*/];
      }
...
},{"../src":"../src/index.ts","zod":"../node_modules/zod/lib/index.mjs"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
